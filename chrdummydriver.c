...
static ssize_t dummychr_read(struct file *f, char __user *buff, size_t len,
		loff_t *off) {
...
static ssize_t dummychr_write(struct file *f, const char __user *buff,
...
static struct file_operations dummychr_ops = { .owner = THIS_MODULE, .open =
		dummychr_open, .release = dummychr_close, .read = dummychr_read,
